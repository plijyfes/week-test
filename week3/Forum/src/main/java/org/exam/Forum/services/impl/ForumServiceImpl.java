...
public class ForumServiceImpl implements ForumService {
	...
	public void saveArticle(Article article, Article parent, User author) { // insert or update(to do:check User and
																			// child)
	...
	public List<Article> findAllVisibleMain(Article parent) {
		return articleDao.findByVisibleTrueAndParentArticleOrderByUpdateTimeDesc(parent);
	}
